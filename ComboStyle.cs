...
namespace WinBud¿et_3
{
	...
	public class ComboStyle:DataGridColumnStyle
	{
		...
		// Passed by ordinal 
		public ComboStyle(ArrayList values)
		{
  		Combo = new ComboBox();
			Combo.Visible=false;
		...
		public void wpiszListe(ArrayList lista)
		{
		...
		{
			// MessageBox.Show("Abort. RowNum = "+RowNum);
		...
		{
      // MessageBox.Show("Edit. Source.Position="+Source.Position+"\nRowNum="+Rownum);
      OldVal = Combo.Text;
